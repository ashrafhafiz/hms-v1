    ...
    <div class="row">
        <div class="col-lg-12 col-md-12">
            <div class="card" id="basic-alert">
                <div class="card-body">
                    <div>
                        <h6 class="mb-1 card-title">Basic Alerts</h6>
...
<div class="alert alert-danger mg-b-0" role="alert">
	...
	<strong>Oh snap!</strong> Change a few things up and try submitting again.
                ...
                <div class="card-footer">
                    <table class="table mt-0 mb-0 main-table-reference">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            <tr>
                                <td><code class="bg-transparent pd-0">class="alert alert-[value]"</code></td>
        ...
        <div class="col-lg-12 col-md-12">
            <div class="card" id="outline-alert">
                <div class="card-body">
                    <div>
                        <h6 class="mb-1 card-title">Outline Alerts</h6>
                        <p class="text-muted card-sub-title">Use one of the four required contextual classes.</p>
                    </div>
                    <div class="text-wrap">
                        <div class="example">
	...
	<strong>Oh snap!</strong> Change a few things up and try submitting again.
                ...
                <div class="card-footer">
                    <table class="table mt-0 mb-0 main-table-reference">
                        ...
                        <tbody>
                            <tr>
                                <td><code class="bg-transparent pd-0">class="alert alert-outline-[value]"</code></td>
                                <td>success | info | warning | danger</td>
                            </tr>
                        </tbody>
                    </table>
        ...
        <div class="col-lg-12 col-md-12">
            <div class="card" id="solid-alert">
                <div class="card-body">
                    <div>
                        <h6 class="mb-1 card-title">Solid Colored Alerts</h6>
                        <p class="text-muted card-sub-title">Use one of the four required contextual classes.</p>
                    </div>
                    <div class="text-wrap">
                        <div class="example">
	...
	<strong>Oh snap!</strong> Change a few things up and try submitting again.
        ...
        <div class="col-lg-12 col-md-12">
            <div class="card custom-card" id="link-alerts">
                <div class="card-body">
                    <div>
                        <h6 class="mb-1 card-title">Link color Alerts</h6>
...
<div class="mb-0 alert alert-dark" role="alert">
  This is a dark alert with <a href="#" class="alert-link">an example link</a>. Give it a click if you like.
            ...
            <div class="card custom-card" id="additional-alerts">
                <div class="card-body">
                    <div>
                        <h6 class="mb-1 card-title">Additional Content Alert</h6>
                    ...
                    <div class="text-wrap">
                        ...
                        <ul class="nav nav-tabs html-source" id="html-source-code5" role="tablist">
                            <li class="nav-item">
                                <a class="ml-1 nav-link active html-code" id="html-code5" data-toggle="tab"
                        ...
                        <figure class="highlight clip-widget" id="alert5">
                            <pre><code class="language-markup"><script type="html-dashlead/script"><div class="mb-0 alert alert-success" role="alert">
  <h4 class="alert-heading">Well done!</h4>
  ...
  <p class="mb-0">Whenever you need to, be sure to use margin utilities to keep things nice and tidy.</p>
            ...
            <div class="card custom-card" id="dismiss-alerts">
                <div class="card-body">
                    <div>
                        <h6 class="mb-1 card-title">Dismissing Alerts</h6>
                    ...
                    <div class="text-wrap">
                        ...
                        <ul class="nav nav-tabs html-source" id="html-source-code6" role="tablist">
                            <li class="nav-item">
                                <a class="ml-1 nav-link active html-code" id="html-code6" data-toggle="tab"
  ...
  <button type="button" class="close" data-dismiss="alert" aria-label="Close">
	<span aria-hidden="true">&times;</span>
            ...
            <div class="card custom-card" id="icon-alerts">
                <div class="card-body">
                    <div>
                        <h6 class="mb-1 card-title">Alert With Icon</h6>
                        <p class="text-muted card-sub-title">Alerts can also contain additional HTML elements like
                            headings, paragraphs and dividers.</p>
                    </div>
                    <div class="text-wrap">
                        ...
                        <ul class="nav nav-tabs html-source" id="html-source-code7" role="tablist">
                            <li class="nav-item">
                                <a class="ml-1 nav-link active html-code" id="html-code7" data-toggle="tab"
...
<div class="mb-0 alert alert-danger" role="alert">
	...
	<span class="alert-inner--text"><strong>Danger!</strong> This is a warning alert—check it out that has an icon too!</span>
            ...
            <div class="card custom-card" id="icon-dismissalerts">
                <div class="card-body">
                    <div>
                        <h6 class="mb-1 card-title">Alert With Icon Dismissing</h6>
                        <p class="text-muted card-sub-title">Alerts can also contain additional HTML elements like
                            headings, paragraphs and dividers.</p>
                    </div>
                    <div class="text-wrap">
                        ...
                        <ul class="nav nav-tabs html-source" id="html-source-code8" role="tablist">
                            <li class="nav-item">
                                <a class="ml-1 nav-link active html-code" id="html-code8" data-toggle="tab"
