...
@section('page-header')
    ...
    <div class="breadcrumb-header justify-content-between">
        <div class="my-auto">
            <div class="d-flex">
                <h4 class="my-auto mb-0 content-title">Elements</h4><span class="mt-1 mb-0 mr-2 text-muted tx-13">/
                    Tabs</span>
            </div>
        </div>
    ...
    <div class="row row-sm">
        <div class="col-lg-12 col-md-12">
            <div class="card" id="basic-alert">
                <div class="card-body">
                    <div>
                        <h6 class="mb-1 card-title">Basic Style Tabs</h6>
                    ...
                    <div class="text-wrap">
                        <div class="example">
                            <div class="panel panel-primary tabs-style-1">
                                ...
                                <div class="border panel-body tabs-menu-body main-content-body-right border-top-0">
                        ...
                        <ul class="nav nav-tabs html-source" id="html-source-code" role="tablist">
                            <li class="nav-item">
                                <a class="ml-1 nav-link active html-code" id="html-code" data-toggle="tab" href="#html-code"
                                    role="tab" aria-controls="html-code" aria-selected="true"><i
                                        class="ml-2 fab fa-html5 text-orange"></i>HTML</a>
                            </li>
                        </ul>
                        <!-- Prism Code -->
                ...
                <div class="card-body">
                    ...
                    <div class="text-wrap">
                        ...
                        <ul class="nav nav-tabs html-source" id="html-source-code2" role="tablist">
                            <li class="nav-item">
                                <a class="ml-1 nav-link active html-code" id="html-code2" data-toggle="tab"
                                    href="#html-code2" role="tab" aria-controls="html-code2" aria-selected="true"><i
                                        class="ml-2 fab fa-html5 text-orange"></i>HTML</a>
                            </li>
                        </ul>
                        <!---Prism Pre code-->
                        <figure class="mb-0 highlight" id="element2">
                            <pre><code class="mb-0 language-markup"><script type="prismsmix/javascript"><div class="panel panel-primary tabs-style-2">
	<div class=" tab-menu-heading">
		<div class="tabs-menu1">
			<!-- Tabs -->
			<ul class="nav panel-tabs main-nav-line">
                ...
                <div class="card-body">
                    ...
                    <div class="text-wrap">
                        ...
                        <ul class="nav nav-tabs html-source" id="html-source-code3" role="tablist">
                            <li class="nav-item">
                                <a class="ml-1 nav-link active html-code" id="html-code3" data-toggle="tab"
                                    href="#html-code3" role="tab" aria-controls="html-code3" aria-selected="true"><i
                                        class="ml-2 fab fa-html5 text-orange"></i>HTML</a>
                            </li>
                        </ul>
                        <!---Prism Pre code-->
                        <figure class="mb-0 highlight" id="element3">
                            <pre><code class="mb-0 language-markup"><script type="prismsmix/javascript"><div class="panel panel-primary tabs-style-3">
	<div class="tab-menu-heading">
		<div class="tabs-menu ">
			<!-- Tabs -->
			<ul class="nav panel-tabs">
                ...
                <div class="card-body">
                    ...
                    <div class="text-wrap">
                        ...
                        <ul class="nav nav-tabs html-source" id="html-source-code4" role="tablist">
                            <li class="nav-item">
                                <a class="ml-1 nav-link active html-code" id="html-code4" data-toggle="tab"
                        ...
                        <!---Prism Pre code-->
                        <figure class="mb-0 highlight" id="element4">
                            <pre><code class="mb-0 language-markup"><script type="prismsmix/javascript"><div class="d-md-flex">
	<div class="">
		<div class="panel panel-primary tabs-style-4">
			<div class="tab-menu-heading">
				<div class="tabs-menu ">
            ...
            <div class="card-body">
                ...
                <div class="text-wrap">
                    ...
                    <ul class="nav nav-tabs html-source" id="html-source-code5" role="tablist">
                        <li class="nav-item">
                            <a class="ml-1 nav-link active html-code" id="js-tab" data-toggle="tab"
                                href="#default-tab" role="tab" aria-controls="default-tab" aria-selected="true"><i
                                    class="ml-2 fab fa-html5 text-orange"></i>HTML</a>
                            <a class="mr-1 nav-link html-code" id="js-tab1" data-toggle="tab" href="#default-tab1"
                                role="tab" aria-controls="default-tab1" aria-selected="true"><i
                                    class="mr-2 fab fa-node-js text-info"></i>JS</a>
                            <a class="mr-1 nav-link html-code" id="js-tab2" data-toggle="tab" href="#default-tab2"
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active" id="default-tab" role="tabpanel" aria-labelledby="html-tab">
                            <!---Prism Pre code-->
                            <figure class="mb-0 highlight" id="element5">
                                <pre><code class="mb-0 language-markup"><script type="prismsmix/javascript"><div class="panel panel-primary">
	<div class="tab_wrapper right_tab">
		<ul class="tab_list">
			<li class="active">Tab 1</li>
			<li>Tab 2</li>
...
src="{{URL::asset('assets/dashboard/plugins/tabs/jquery.multipurpose_tabcontent.js')}}"</script></code></pre>
                                <div class="clipboard-icon" data-clipboard-target="#element5"><i
                                        class="las la-clipboard"></i></div>
                            </figure>
                        </div>
...
src="{{URL::asset('assets/dashboard/js/tabs.js')}}"</script></code></pre>
                                <div class="clipboard-icon" data-clipboard-target="#element5"><i
                                        class="las la-clipboard"></i></div>
                            </figure>
                        </div>
...
@section('js')
    ...
    <script src="{{ URL::asset('assets/dashboard/plugins/custom-scroll/jquery.mCustomScrollbar.concat.min.js') }}"></script>
