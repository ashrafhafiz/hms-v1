		...
		<button class="btn btn-dark btn-block">Dark</button>
                ...
                <div class="card-footer">
                    <table class="table mt-0 mb-0 main-table-reference">
                        ...
                        <tbody>
                            <tr>
                                <td><code class="bg-transparent pd-0">class="btn btn-[value]"</code></td>
                ...
                <div class="card-body">
                    ...
                    <div class="text-wrap">
                        ...
                        <ul class="nav nav-tabs html-source" id="html-source-code22" role="tablist">
                            <li class="nav-item">
                                <a class="ml-1 nav-link active html-code" id="html-code22" data-toggle="tab"
                                    href="#html-code22" role="tab" aria-controls="html-code22"
                                    aria-selected="true"><i class="ml-2 fab fa-html5 text-orange"></i>HTML</a>
                            </li>
                        </ul>
                        <!-- Prism Precode -->
		...
		<button class="btn btn-outline-dark btn-block">Dark</button>
                ...
                <div class="card-footer">
                    <table class="table mt-0 mb-0 main-table-reference">
                        ...
                        <tbody>
                            <tr>
                                <td><code class="bg-transparent pd-0">class="btn btn-outline-[value]"</code></td>
                                <td> primary | secondary | success | warning | danger | info | light | dark</td>
                            </tr>
                        </tbody>
                    </table>
