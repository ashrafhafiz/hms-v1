    ...
    <div class="row">
        <div class="col-xl-12 col-lg-12">
            <div class="card" id="popover">
                <div class="card-body">
                    <div>
                        <h6 class="mb-1 card-title">DEFAULT POPOVER</h6>
                    ...
                    <div class="text-wrap">
                        <div class="example">
                            <div class="mb-1 tx-10 font-weight-bold text-muted text-uppercase">
                                STATIC EXAMPLE
                            </div>
                        ...
                        <ul class="nav nav-tabs html-source" id="html-source-code" role="tablist">
                            <li class="nav-item">
                                <a class="ml-1 nav-link active html-code" id="html-code" data-toggle="tab"
