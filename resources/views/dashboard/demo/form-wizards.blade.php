...
<script src="{{URL::asset('assets/dashboard/plugins/jquery-steps/jquery.steps.min.js')}}"></script>
<script src="{{URL::asset('assets/dashboard/plugins/parsleyjs/parsley.min.js')}}"></script>
<!--Internal  Form-wizard js -->
<script src="{{URL::asset('assets/dashboard/js/form-wizard.js')}}"></script>
@endsection
